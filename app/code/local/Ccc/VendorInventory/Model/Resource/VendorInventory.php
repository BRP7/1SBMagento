<?php
class Ccc_VendorInventory_Model_Resource_VendorInventory extends Mage_Core_Model_Resource_Db_Abstract
{
    protected function _construct()
    {
        // parent::_construct();
        $this->_init('ccc_vendorinventory/ccc_vendorinventory', 'id');
    }
