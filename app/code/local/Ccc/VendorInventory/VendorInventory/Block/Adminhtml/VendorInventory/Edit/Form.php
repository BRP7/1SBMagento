...
class Ccc_VendorInventory_Block_Adminhtml_Banner_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    {
        parent::__construct();
        $this->setId('vendorinventory_form');
        $this->setTitle(Mage::helper('vendorinventory')->__('Inventory Information'));
    }
    ...
    protected function _prepareForm()
    {
        $model = Mage::registry('vendorinventory_block');
