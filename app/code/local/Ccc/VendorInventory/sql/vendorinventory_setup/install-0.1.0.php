...
$table = $installer->getConnection()
    ...
    ->newTable($installer->getTable('ccc_vendorinventory/configuration'))
...
$table = $installer->getConnection()
    ...
    ->newTable($installer->getTable('ccc_vendorinventory/rule'))
    ->addColumn('id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
...
$table = $installer->getConnection()
    ...
    ->newTable($installer->getTable('ccc_vendorinventory/instock_date'))
