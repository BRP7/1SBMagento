...
class Practice_Rowedit_Block_Adminhtml_Rowedit_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('status', array(
            'header' => Mage::helper('practice_rowedit')->__('Status'),
            'align' => 'left',
            'index' => 'status', // Make sure to use correct index
            'type' => 'options',
            'options' => array(
                '1' => Mage::helper('practice_rowedit')->__('Enabled'),
                '0' => Mage::helper('practice_rowedit')->__('Disabled'),
            ),
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            'status',
            array(
                'label' => Mage::helper('practice_rowedit')->__('Change status'),
                ...
                'additional' => array(
                    'visibility' => array(
                        ...
                        'label' => Mage::helper('practice_rowedit')->__('Status'),
                        'values' => $statuses
                    )
                )
            )
